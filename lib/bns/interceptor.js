...
function authUpdate(aop) {
    ...
    return function (response) {
        ...
        if (response.data.code == '103108' || response.data.code == '103144' || response.data.code == '103100' || response.data.errId == '103108' || response.data.errId == '103144' || response.data.errId == '103100') {
            (0, _logout2.default)();
        }
