...
function auth(aop) {
    ...
    return function (response) {
        ...
        if (response.data.code == '103108' || response.data.code == '103144') {
            ...
            _local2.default.$cookie.clear('TOKEN', '.' + _util2.default.parseUrl(location.href).host);
            _local2.default.$cookie.clear('groupKey');
            _local2.default.$cookie.clear('groupKey', '.' + _util2.default.parseUrl(location.href).host);
