    ...
    return (0, _keys2.default)(sub).reduce(function (ctx, key) {
        ...
        ctx[key] = function (parse) {
            ...
            if (~headRequest.indexOf(method)) {
                config = data;
                data = null;
                config = expandHeaders({ config: config, contentType: contentType, apiname: key, baseURL: ROOT, abort: abort, binary: binary, withCredentials: withCredentials, mock: mock });
