...
function getRedirectUrl (notRememberUrl) {
  ...
  //   }
    if(notRememberUrl){
      redirectUrl =  `http://authentication.${primaryDomain}/#/pc/login/commons`
    }else{
      redirectUrl = `http://authentication.${primaryDomain}/?service=${encodeURIComponent(location.href)}#/pc/login/commons`
    }
